...
"""
a2 ֆունկցիան n > 1 դեքպում -> ackermann(0, ackermann(1, n - 1)),
ackermann(0, ackermann(0, ackermann(1, n - 2)))․․․ ackermann(0,․․․, ackermann(1, {n (n - 1) == 1})), n - 1 հատ
վերջին արժեքն = 2 ստացվում է 2 * 2 * 2 * ... * 2 = 2 ** n
"""
...
"""
a3 ֆունկցիան n > 1 դեքպում -> ackermann(1, ackermann(2, n - 1)),
ackermann(1, ackermann(1, ackermann(2, n - 2)))  a2-ի նման շարունակելով ստացվում է 2 ** 2 ** 2 ... ** 2
ընհանուր n անգամ
"""